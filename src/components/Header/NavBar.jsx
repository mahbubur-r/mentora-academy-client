...
const NavBar = () => {
    ...
    return (
        <div className='Navbar parent bg-base-100/90 backdrop-blur-md text-base-content shadow sticky top-0 z-50'>
            <div className="navbar bg-base-100 px-4 md:px-16">
                <div className="navbar-start">
                    <div className="dropdown">
                        <div tabIndex={0} role="button" className="btn btn-ghost md:hidden text-[#FF8811]">
                    ...
                    {user ? (
                        <div className="dropdown dropdown-end z-50">
                            ...
                            <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                                <li>
                                    <Link to="/dashboard/profile" className="justify-between font-bold text-base-content">
                                        Profile
                                        <span className="badge bg-[#FF8811] text-white border-none">New</span>
                                    </Link>
                                </li>
                                <li><Link to="/dashboard" className="font-bold text-base-content">Dashboard</Link></li>
