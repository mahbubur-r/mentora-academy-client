...
const Login = () => {
    ...
    const handleDemoLogin = (e) => {
        e.preventDefault();
        if (emailRef.current) emailRef.current.value = "demo@mentora.com";
        if (passwordRef.current) passwordRef.current.value = "Demo@123";
    }
                    ...
                    <form onSubmit={handleLogin}>
                        <fieldset className="fieldset">
                            ...
                            <div className="relative">
                                <input required ref={passwordRef} type={showPass ? 'text' : 'password'} name="password" className="input" placeholder="Password" />
                                <button
